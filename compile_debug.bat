...
cmake -DRAY_IT_USE_FLOATS=OFF -DRAY_IT_COMPILATION_TYPE=%COMPILATION_TYPE% . -G "Visual Studio 17 2022" -A x64 -DCMAKE_CXX_FLAGS="/MP3 /EHsc /W3" -B"build\%COMPILATION_TYPE%"
