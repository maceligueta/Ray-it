...
cmake -DRAY_IT_USE_FLOATS=ON -DRAY_IT_COMPILATION_TYPE=%COMPILATION_TYPE% . -G "Visual Studio 16 2019" -A x64 -DCMAKE_CXX_FLAGS="/MP3 /EHsc /Ot" -B"build\%COMPILATION_TYPE%"
